...
class SemestersControllerTest < ActionController::TestCase
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post :create, semester: { classroom_id: @semester.classroom_id, completed: @semester.completed, name: @semester.name }
    end
  ...
  test "should update semester" do
    patch :update, id: @semester, semester: { classroom_id: @semester.classroom_id, completed: @semester.completed, name: @semester.name }
    assert_redirected_to semester_path(assigns(:semester))
  end
