...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { batch_id: @classroom.batch_id, completed: @classroom.completed, dept_id: @classroom.dept_id, name: @classroom.name }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { batch_id: @classroom.batch_id, completed: @classroom.completed, dept_id: @classroom.dept_id, name: @classroom.name }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
